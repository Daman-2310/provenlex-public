...
const ITEMS: Item[] = [
  // Mythological tier
  { href: '/book',            label: 'The Book of ProvenLex',          description: '100 sealed prophecies · anchored on Bitcoin\'s blockchain',          group: 'Mythological', Icon: BookOpen,    keywords: ['book','genesis','100','bitcoin','blockchain','prophecies','sealed','peak'] },
  ...
  { href: '/globe',           label: 'ProvenLex Globe',                description: 'All 100 prophecies plotted in 3D · color-graded by Pre-Crime Index',  group: 'Mythological', Icon: Globe2,      keywords: ['globe','3d','map','jurisdiction','geographic','world','heatmap','threat'] },
  { href: '/network',         label: 'ProvenLex Network',              description: 'Counterparty exposure graph · contagion ripples 3 hops along edges',  group: 'Mythological', Icon: Network,     keywords: ['network','graph','counterparty','contagion','edges','custody','prime broker','bloomberg'] },
  { href: '/oracle',          label: 'ProvenLex Oracle',               description: 'Signed ProvenLex scores over HTTP · DeFi/RWA/insurance read on-chain',  group: 'Developers',   Icon: Cpu,         keywords: ['oracle','chainlink','onchain','solidity','defi','rwa','smart contract','tokenization'] },
  ...
  { href: '/obituary',        label: 'ProvenLex Obituary',             description: 'Forensic post-mortems of Wirecard, Greensill, Archegos, FTX, SVB',     group: 'Mythological', Icon: AlertOctagon, keywords: ['obituary','wirecard','greensill','archegos','ftx','svb','forensic','post-mortem','backcast'] },
  { href: '/twin',            label: 'ProvenLex Twin',                 description: 'Monte Carlo stress simulator · 10k trials per entity per scenario',    group: 'Mythological', Icon: BarChart3,   keywords: ['twin','monte carlo','stress test','simulation','rate shock','credit crunch','redemption'] },
  { href: '/sentinel',        label: 'ProvenLex Sentinel',             description: '12 autonomous agents posting findings live · the AI lab feed',         group: 'Mythological', Icon: Activity,    keywords: ['sentinel','bots','autonomous','agents','feed','live','ai lab','vesta','cassius'] },
  { href: '/codex',           label: 'ProvenLex Codex',                description: 'Open compliance LLM · API now · self-hostable .gguf in Q4',           group: 'Developers',   Icon: Brain,       keywords: ['codex','llm','model','gguf','llama','aifmd','ucits','sfdr','self-host','open source'] },
  ...
  { href: '/architecture',    label: 'The ProvenLex Engine · 7 Pillars', description: 'Law as software · code-to-law, ZK vaults, red-team, precedent, topology, twins, kinetic', group: 'Developers', Icon: Cpu,    keywords: ['architecture','engine','pillars','code-to-law','zero knowledge','red team','topology','kinetic','compliance kernel','loop'] },
  ...
  { href: '/timemachine',     label: 'The Time Machine',             description: 'Backtest: ProvenLex would have caught every major EU collapse',        group: 'Mythological', Icon: Rewind,      keywords: ['time machine','backtest','accuracy','wirecard','foresight','proof'] },
  ...
  { href: '/daily',           label: 'The ProvenLex Daily',            description: 'Free 5-min morning brief · 07:00 UTC daily',                         group: 'Mythological', Icon: Mail,        keywords: ['daily','newsletter','email','subscribe','brief','morning'] },
  ...
  { href: '/bounty',          label: 'The ProvenLex Bounty',           description: '€10,000 if you can fool the ProvenLex scoring engine',                  group: 'Mythological', Icon: Crosshair,   keywords: ['bounty','adversarial','fool','break','researcher','prize'] },
  ...
  { href: '/etf',             label: 'PROVENLEX-50 Index',             description: 'ETF licensing pitch · top 50 EU funds by ProvenLex Score',             group: 'Mythological', Icon: Coins,       keywords: ['etf','index','genesis-50','licensing','msci','asset manager'] },
  { href: '/almanac',         label: 'The ProvenLex Almanac',          description: 'Printed annual hardback · mailed free to regulators',                group: 'Mythological', Icon: BookMarked,  keywords: ['almanac','hardback','printed','annual','book','physical'] },
  { href: '/federation',      label: 'The ProvenLex Federation',       description: 'Open API — publish your compliance scores into the ledger',           group: 'Mythological', Icon: Network,     keywords: ['federation','api','publish','aggregator','github of compliance'] },
  ...
  { href: '/funds',           label: 'The 35,000 Project',           description: 'A ProvenLex dossier for every legal entity · 2.4M LEIs',               group: 'Mythological', Icon: Globe2,      keywords: ['funds','35000','lei','gleif','dossier','wikipedia','public'] },
  { href: '/protocol',        label: 'ProvenLex Protocol',             description: 'PROVENLEX-1 open standard · Apache 2.0',                              group: 'Mythological', Icon: BookOpen,    keywords: ['protocol','genesis-1','standard','spec','open','apache'] },
  { href: '/embed-docs',      label: 'Embed the Score',              description: 'iframe-able ProvenLex badges for any website',                         group: 'Developers',   Icon: Code2,       keywords: ['embed','iframe','badge','widget','distribute'] },
  ...
  // Company
  { href: '/about',           label: 'About · Why Deterministic',    description: 'Who built ProvenLex and why it has no AI in the decision path', group: 'Company',    Icon: Globe2,      keywords: ['about','founder','story','daman','deterministic','why'] },
      ...
      <div onClick={e => e.stopPropagation()}
        ...
        <div className="relative px-5 py-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <input ref={inputRef} type="text" value={q}
            ...
            onKeyDown={onKeyDown}
            placeholder="Search ProvenLex... (try 'audit', 'api', 'wirecard', 'token')"
